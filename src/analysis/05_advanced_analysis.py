...
print("\n=== INTERPRETATION ===")
print("• Orange Line: Highest mean RSS (88.76) with narrowest CI (11.89)")
print("  → Most consistent performance across stations")
print("• Blue Line: Lower mean (85.64) with widest CI (13.24)")
print("  → Most variable performance, some stations much worse")
...
print("-" * 70)
print("✅ Week 1: Data consolidation (Eric)")
print("✅ Week 2: RSS calculation with literature-based weights")
print("✅ Week 3: Advanced analytics")
print("   • Hypothesis testing (ANOVA)")
print("   • Station-level breakdown (111 stations)")
print("   • Bootstrap confidence intervals (1000 resamples)")
print("   • Predictive regression model (R²=1.0)")
print("   • Equity analysis (income + race)")

print("\n🎯 KEY FINDINGS:")
print("-" * 70)
print("1. RSS SCORES (Literature-Based):")
print("   • Orange: 100.0 (best overall)")
print("   • Red: 68.0")
print("   • Blue: 60.0")

print("\n2. STATION-LEVEL ANALYSIS:")
print("   • 111 stations analyzed")
print("   • Best: Red-70085 (100.0)")
print("   • Worst: Orange-70007 (60.0)")
print("   • Orange most consistent (CI width: 11.89)")

print("\n3. HYPOTHESIS TESTING:")
print("   • Volatility: Significantly different (p=0.018)")
print("   • On-Time Performance: Not significant (p=0.229)")

print("\n4. EQUITY ANALYSIS:")
print("   • NO DISCRIMINATION: Orange (best RSS) serves:")
print("     - 61% low-income riders")
print("     - 66% minority riders")
print("   • Positive correlation (r=1.0)")

print("\n5. PREDICTIVE MODEL:")
print("   • Ridge Regression: R²=1.0, RMSE=0.04")
print("   • Most important: Buffer time & volatility")
print("   • Learned weights align with literature")
...
print("\n⚙️ TECHNOLOGIES USED:")
print("-" * 70)
print("  • PySpark: Data loading & initial processing")
print("  • Pandas: Data manipulation & analysis")
print("  • Seaborn/Matplotlib: Visualizations")
print("  • Scikit-learn: Regression modeling")
print("  • SciPy: Hypothesis testing (ANOVA, t-tests)")
print("  • Bootstrap resampling: Confidence intervals")
