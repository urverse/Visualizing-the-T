...
print("\n📊 FINAL RSS SCORES (Literature-Based Weights):")
...
print("\n🔑 KEY INSIGHTS:")
print("  • Orange Line: Best overall (100.0)")
print("    - Excellent OTP (1.06 z-score)")
print("    - Low volatility (0.30 z-score)")
print("  • Red Line: Middle (68.0)")
print("    - Best volatility (1.05 z-score)")
print("    - Worst OTP (-1.34 z-score)")
print("  • Blue Line: Lowest (60.0)")
print("    - Worst volatility (-1.35 z-score)")
print("    - Worst buffer time (-1.39 z-score)")

print("\n⚙️ METHODOLOGY:")
print("  • Data: 1,850 route segments, 36K trips")
print("  • Indicators: Travel time, volatility, buffer, OTP, restrictions")
print("  • Normalization: Z-scores")
print("  • Weights: Literature-based (reliability prioritized)")
print("  • Scale: 60-100")

print("\n✅ DELIVERABLES:")
print("  • rss_final_results.csv - all scores and components")
print("  • rss_weights.csv - weight justifications")
print("  • Visualizations - 4 charts")
