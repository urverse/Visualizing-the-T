...
- **Historical averages** (hy_avg_*): Enable trend analysis and anomaly detection
...
- **Calculation**: average_* fields = total_* / number_service_days
...
- **Time Impact**: Some records include pre-calculated delay (Speed_Restriction_Travel_Time_*_Added)
...
3. **Delay Attribution**: Use Speed_Restriction_Travel_Time_*_Added to explain travel time variance
